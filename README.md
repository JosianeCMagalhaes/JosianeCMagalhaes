...
Analista e Desenvolvedora de Sistemas Full Stack, atuo no desenvolvimento e na evolução de soluções digitais com foco em eficiência e confiabilidade. Sou formada em Análise e Desenvolvimento de Sistemas, atualmente curso Bacharelado em Ciência de Dados e realizo pós-graduação em Arquitetura de Software e em Proteção e Uso de Dados Pessoais. Possuo certificação Oracle Cloud Infrastructure (OCI Foundations Associate).
